...
public class PLSQLParser extends Parser {
	...
	public final Continue_statementContext continue_statement() throws RecognitionException {
		...
		try {
			...
			if (_la==ID) {
				{
				setState(687);
				((Continue_statementContext)_localctx).lbl = match(ID);
				}
			}
	...
	public final Exit_statementContext exit_statement() throws RecognitionException {
		...
		try {
			...
			if (_la==ID) {
				{
				setState(712);
				((Exit_statementContext)_localctx).lbl = match(ID);
				}
			}
	...
	public final Create_packageContext create_package() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1207);
				((Create_packageContext)_localctx).schema_name = match(ID);
				setState(1208);
				match(DOT);
				}
				break;
			...
			setState(1211);
			((Create_packageContext)_localctx).package_name = match(ID);
			setState(1213);
			_la = _input.LA(1);
			if (_la==AUTHID) {
				{
	...
	public final Create_package_bodyContext create_package_body() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1232);
				((Create_package_bodyContext)_localctx).schema_name = match(ID);
				setState(1233);
				match(DOT);
				}
				break;
			...
			setState(1236);
			((Create_package_bodyContext)_localctx).package_name = match(ID);
			setState(1237);
			_la = _input.LA(1);
			if ( !(_la==AS || _la==IS) ) {
			_errHandler.recoverInline(this);
			...
			case BEGIN:
				{
				setState(1241);
				((Create_package_bodyContext)_localctx).initialize_section = body();
				}
				break;
			case END:
				{
				...
				if (_la==ID) {
					{
					setState(1243);
					((Create_package_bodyContext)_localctx).package_name2 = match(ID);
					}
				}
	...
	public final Create_procedureContext create_procedure() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1256);
				((Create_procedureContext)_localctx).schema_name = match(ID);
				setState(1257);
				match(DOT);
				}
				break;
			...
			setState(1260);
			((Create_procedureContext)_localctx).procedure_name = match(ID);
			setState(1272);
			_la = _input.LA(1);
			if (_la==LPAREN) {
				{
	...
	public final Create_functionContext create_function() throws RecognitionException {
		...
		try {
			...
			case 1:
				{
				setState(1294);
				((Create_functionContext)_localctx).schema_name = match(ID);
				setState(1295);
				match(DOT);
				}
				break;
			...
			setState(1298);
			((Create_functionContext)_localctx).function_name = match(ID);
			setState(1310);
			_la = _input.LA(1);
			if (_la==LPAREN) {
				{
	...
	public boolean sempred(RuleContext _localctx, int ruleIndex, int predIndex) {
		switch (ruleIndex) {
		case 108:
			return kERRORS_sempred((KERRORSContext)_localctx, predIndex);
		case 109:
			return kEXCEPTIONS_sempred((KEXCEPTIONSContext)_localctx, predIndex);
		case 110:
			return kFOUND_sempred((KFOUNDContext)_localctx, predIndex);
		case 111:
			return kINDICES_sempred((KINDICESContext)_localctx, predIndex);
		case 112:
			return kMOD_sempred((KMODContext)_localctx, predIndex);
		case 113:
			return kNAME_sempred((KNAMEContext)_localctx, predIndex);
		case 114:
			return kOF_sempred((KOFContext)_localctx, predIndex);
		case 115:
			return kREPLACE_sempred((KREPLACEContext)_localctx, predIndex);
		case 116:
			return kROWCOUNT_sempred((KROWCOUNTContext)_localctx, predIndex);
		case 117:
			return kSAVE_sempred((KSAVEContext)_localctx, predIndex);
		case 118:
			return kSHOW_sempred((KSHOWContext)_localctx, predIndex);
		case 119:
			return kTYPE_sempred((KTYPEContext)_localctx, predIndex);
		case 120:
			return kVALUES_sempred((KVALUESContext)_localctx, predIndex);
		}
		return true;
	}
	private boolean kERRORS_sempred(KERRORSContext _localctx, int predIndex) {
		switch (predIndex) {
		case 0:
			return _input.LT(1).getText().length() >= 3 && "errors".startsWith(_input.LT(1).getText().toLowerCase());
		}
		return true;
	}
	private boolean kEXCEPTIONS_sempred(KEXCEPTIONSContext _localctx, int predIndex) {
		switch (predIndex) {
		case 1:
			return _input.LT(1).getText().equalsIgnoreCase("exceptions");
		}
		return true;
	}
	private boolean kFOUND_sempred(KFOUNDContext _localctx, int predIndex) {
		switch (predIndex) {
		case 2:
			return _input.LT(1).getText().equalsIgnoreCase("found");
		}
		return true;
	}
	private boolean kINDICES_sempred(KINDICESContext _localctx, int predIndex) {
		switch (predIndex) {
		case 3:
			return _input.LT(1).getText().equalsIgnoreCase("indices");
		}
		return true;
	}
	private boolean kMOD_sempred(KMODContext _localctx, int predIndex) {
		switch (predIndex) {
		case 4:
			return _input.LT(1).getText().equalsIgnoreCase("mod");
		}
		return true;
	}
	private boolean kNAME_sempred(KNAMEContext _localctx, int predIndex) {
		switch (predIndex) {
		case 5:
			return _input.LT(1).getText().equalsIgnoreCase("name");
		}
		return true;
	}
	private boolean kOF_sempred(KOFContext _localctx, int predIndex) {
		switch (predIndex) {
		case 6:
			return _input.LT(1).getText().equalsIgnoreCase("of");
		}
		return true;
	}
	private boolean kREPLACE_sempred(KREPLACEContext _localctx, int predIndex) {
		switch (predIndex) {
		case 7:
			return _input.LT(1).getText().equalsIgnoreCase("replace");
		}
		return true;
	}
	private boolean kROWCOUNT_sempred(KROWCOUNTContext _localctx, int predIndex) {
		switch (predIndex) {
		case 8:
			return _input.LT(1).getText().equalsIgnoreCase("rowcount");
		}
		return true;
	}
	private boolean kSAVE_sempred(KSAVEContext _localctx, int predIndex) {
		switch (predIndex) {
		case 9:
			return _input.LT(1).getText().equalsIgnoreCase("save");
		}
		return true;
	}
	private boolean kSHOW_sempred(KSHOWContext _localctx, int predIndex) {
		switch (predIndex) {
		case 10:
			return _input.LT(1).getText().equalsIgnoreCase("show");
		}
		return true;
	}
	private boolean kTYPE_sempred(KTYPEContext _localctx, int predIndex) {
		switch (predIndex) {
		case 11:
			return _input.LT(1).getText().equalsIgnoreCase("type");
		}
		return true;
	}
	private boolean kVALUES_sempred(KVALUESContext _localctx, int predIndex) {
		switch (predIndex) {
		case 12:
			return _input.LT(1).getText().equalsIgnoreCase("values");
		}
		return true;
	}
